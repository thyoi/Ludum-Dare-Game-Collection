...
func Slice(type:String)->Array:
	if type =="":
		return SlotList
	elif type == "l00":
		return _shiftCountroler._randSliceInLine(false,false)
	elif type == "l10":
		return _shiftCountroler._randSliceInLine(true,false)	
	elif type == "l01":
		return _shiftCountroler._randSliceInLine(false,true)	
	elif type == "l11":
		return _shiftCountroler._randSliceInLine(true,true)	
